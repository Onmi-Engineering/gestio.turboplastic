...
class StockPicking(models.Model):
    ...
    date_planned = fields.Datetime(string='Date final weight', index=True, copy=False, store=True, readonly=False)
    ...
    def _compute_totals(self):
        for rec in self:
            ...
            for line in rec.move_ids_without_package:
                ...
                qty_done = sum(move_line.quantity for move_line in move_lines) if move_lines else 0.0
    ...
    def _action_done(self):
        ...
        for move in self.move_ids_without_package:
            ...
            if not sale_order or move.location_dest_id.usage != 'customer' or move.sale_line_id or not move.quantity:
                continue
    ...
    def asign_license_plate(self):
        """
        Si se rellena el campo de Matrícula del albarán se asigna a todos los pesajes.
        :return:
        """
        for rec in self:
    ...
    def asign_trailer(self):
        """
        Si se rellena el campo de Remolque del albarán se asigna a todos los pesajes.
        :return:
        """
        for rec in self:
            if rec.trailer_id:
    ...
    def asign_date(self):
        """
        Si se rellena el campo de Fecha de carga del albarán se asigna a todos los pesajes.
        :return:
        """
        for rec in self:
            if rec.upload_date:
    ...
    def action_confirm_weighings(self):
        ...
        si pasa las validaciones.
            ...
            * Validaciones:
                - Remolque o matrícula no relleno (significa que Transporte no confirmado), Error.
        ...
        for weight in self.weighing_ids:
            ...
            if move_lines:
                for line in move_lines:
                    line.quantity = weight.final_weight
            else:
